...
public class StuffFactoryTest {
    ...
    public void newPlayer() throws Exception {
        ...
        for (int x = 0; x < WIDTH; x++)
            for (int y = 0; y < HEIGHT; y++)
                if (world.getCreature(x, y) == player)
                    return;
    ...
    public void newFungus() throws Exception {
        ...
        for (int x = 0; x < WIDTH; x++)
            for (int y = 0; y < HEIGHT; y++)
                if (world.getCreature(x, y) == fungus)
                    return;
    ...
    public void newLightArmor() throws Exception {
        ...
        for (int x = 0; x < WIDTH; x++)
            for (int y = 0; y < HEIGHT; y++)
                if (world.getItem(x, y) == item)
                    return;
        Assert.fail("Is not found light getArmor");
    }
    ...
    public void newMediumArmor() throws Exception {
        ...
        for (int x = 0; x < WIDTH; x++)
            for (int y = 0; y < HEIGHT; y++)
                if (world.getItem(x, y) == item)
                    return;
        Assert.fail("Is not found medium getArmor");
    }
    ...
    public void newHeavyArmor() throws Exception {
        ...
        for (int x = 0; x < WIDTH; x++)
            for (int y = 0; y < HEIGHT; y++)
                if (world.getItem(x, y) == item)
                    return;
        Assert.fail("Is not found heavy getArmor");
    }
        ...
        for (int x = 0; x < WIDTH; x++)
            for (int y = 0; y < HEIGHT; y++)
                if (world.getItem(x, y) != null)
                    return;
        Assert.fail("Is not found random getWeapon");
    }
    ...
    public void randomArmor() throws Exception {
        ...
        for (int x = 0; x < WIDTH; x++)
            for (int y = 0; y < HEIGHT; y++)
                if (world.getItem(x, y) != null)
                    return;
        Assert.fail("Is not found random getArmor");
    }
